      ...
      <div class="content-display pull-left">
        <div v-if="showState" class="CompanyIndex">
          ...
          <div class="company-pag">
            <el-pagination background layout="prev, pager, next" :current-page="page" :total="total" :page-size="size" @current-change="handleCurrentChange">
            </el-pagination>
          </div>
        </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapMutations([]),
      toRelease () {
        this.$router.push({path: '/home/busSuperRelease'})
      },
      // 查询未读信息数量
      checkMsg() {
      },
