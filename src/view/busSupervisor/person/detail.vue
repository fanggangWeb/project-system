<template>
  <div class="container">
    <div class="header">首页&nbsp;>&nbsp;<router-link to="/home/busSuperPerson">人员</router-link>&nbsp;>&nbsp;人员详情</div>
    <div class="nav">
    ...
    <div class="tables2">
      <div class="project-content">
        <div class="project-top">
          <div class="project-top-up">{{otherInfo.signedCount}}</div>
          <div class="project-top-under"><img src="../../../assets/project-statistics-slices/projectNumber.png"> 接受任务次数</div>
        </div>
        <!-- <div class="project-top">
        ...
        <div class="project-top">
          <div class="project-top-up">{{otherInfo.taskCount}}</div>
          <div class="project-top-under"><img src="../../../assets/project-statistics-slices/complete.png"> 成功签约次数</div>
        </div>
        <div class="project-top">
          <div class="project-top-up">{{otherInfo.trailCount}}</div>
          <div class="project-top-under"><img src="../../../assets/project-statistics-slices/haveInHand.png"> 跟进次数</div>
        </div>
      </div>
...
<script>
  ...
  import { attendanceInfo, staffUserInfo, staffDaildyTask, businessStatics } from '@/api/request'
  export default {
    data() {
      return {
        userInfo: {},
    ...
    methods: {
      ...
      _businessStatics () {
        businessStatics({userId: this.getstaffId}).then(res => {
          res = res.data
          if (res.state == SUCCESS_OK) {
