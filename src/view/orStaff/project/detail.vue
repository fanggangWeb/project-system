  ...
  <div class="container">
    ...
    <div class="details-content">
      <div class="details-menu">
        <ul>
          <li>
            <router-link to="/home/orProjectDetail/" exact>概况</router-link>
          </li>
          <li>
            <router-link to="/home/orProjectDetail/data">资料</router-link>
          </li>
          <li>
            <router-link to="/home/orProjectDetail/complete">任务完成率</router-link>
          </li>
        </ul>
      </div>
